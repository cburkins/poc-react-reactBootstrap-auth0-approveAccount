...
const onRedirectCallback = (appState) => {
    console.log("inside onRedirectCallback() appState 01:", appState);
    console.log("inside onRedirectCallback() re-routing to window.location.pathname :", window.location.pathname);
